...
public class ViewPagerIndicator extends LinearLayout {
    ...
    public ViewPagerIndicator(Context context, AttributeSet attrs) {
        ...
        a.recycle();
        COLOR_TEXT_NORMAL = ContextCompat.getColor(context, R.color.textGrayMiddle);
        COLOR_TEXT_HIGHLIGHT = ContextCompat.getColor(context, R.color.red_bg);
    ...
    private View generateTextView(String title) {
        ...
        int size = (int) getResources().getDimension(R.dimen.dimen_60px);
