...
public class Constants {
	// 鲜篮子Html页面http://xlanzi.com/index.php/Mobile/Session/login.html
	//public static final String XIAN_LAN_ZHI = "http://xlanzi.com/index.php/Mobile/Session/login.html";
	//正式地址
	...
	public static final String TEST_CURRENT_URL = "http://test.cengfan7.cn/wap.php";// "http://xlanzi.com/index.php/Mobile/Session/login.html";
...

   ...
   // public static final String ALIPAY_NOTIFY_URL="http://test.cengfan7.cn/wap.php/Alipay/notifyApp";
    //支付宝充值回调地址 RECHARGE
    public static final String ALIPAY_RECHARGE_NOTIFY_URL="cengfan7.cn/wap.php/Alipay/recharge_notify_app";//http://test.cengfan7.cn/wap.php/Alipay/recharge_notify_app";
    //支付成功后回调地址通知页面更新
