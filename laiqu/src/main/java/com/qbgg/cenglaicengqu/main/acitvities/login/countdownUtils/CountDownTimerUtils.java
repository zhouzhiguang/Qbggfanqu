package com.qbgg.cenglaicengqu.main.acitvities.login.countdownUtils;
...
public class CountDownTimerUtils extends CountDownTimer {
    ...
    public void onTick(long millisUntilFinished) {//该方法在倒计时时调用
        ...
        mTextView.setTextColor(ContextCompat.getColor(mTextView.getContext(),R.color.borderDeep));
    ...
    public void onFinish() {//计时结束之后实现这个方法
        ...
        mTextView.setTextColor(ContextCompat.getColorStateList(mTextView.getContext() ,R.drawable.selector_login_text));//还原背景色
    }
}
