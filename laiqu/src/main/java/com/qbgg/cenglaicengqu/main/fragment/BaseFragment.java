 ...
 */
public abstract  class  BaseFragment extends TabFragment implements FragmentLifecycleProvider {
    //是否可见状态
    ...
    public void onAttach(Activity activity) {
        ...
        mApp = (LaiquApplication) activity.getApplication();
