package com.qbgg.cenglaicengqu.location.activity;
...
import com.qbgg.cenglaicengqu.location.adapter.IconListAdapter;
import com.qbgg.cenglaicengqu.location.adapter.IconListAdapter.IconListItem;
import com.qbgg.cenglaicengqu.location.helper.MapHelper;
import com.qbgg.cenglaicengqu.location.helper.NimLocationManager;
import com.qbgg.cenglaicengqu.location.helper.NimLocationManager.NimLocationListener;
...
public class NavigationAmapActivity extends UI implements
	...
	private void doNavigate(final NimLocation origin, final NimLocation des) {
		List<IconListItem> items = new ArrayList<IconListItem>();
