...
public class UserProfileActivity extends UI {
    ...
    private final boolean FLAG_ADD_FRIEND_DIRECTLY = false; // 是否直接加为好友开关，false为需要好友申请 true 为直接加好友不需要验证
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        AutoUtils.auto(this);
        user_profile_title = findView(R.id.user_profile_title);
        ToolBarOptions options = new ToolBarOptions();
        options.titleId = R.string.user_profile;
        setToolBar(R.id.toolbar, options);
        setTitle("");
        user_profile_title.setText(R.string.user_profile);
    ...
    private void updateUserInfoView() {
        ...
        if (userInfo.getGenderEnum() == GenderEnum.MALE) {
            ...
            genderImage.setBackgroundResource(R.mipmap.nim_male);
