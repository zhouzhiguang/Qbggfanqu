...
import com.qbgg.cenglaicengqu.contact.viewholder.BlackListViewHolder;
...
public class BlackListActivity extends UI implements TAdapterDelegate {
    ...
    private void findViews() {
        ...
        notifyText.setBackgroundColor(ContextCompat.getColor(getApplicationContext(),R.color.color_yellow_fcf3cd));
        notifyText.setTextColor(ContextCompat.getColor(getApplicationContext(),R.color.color_yellow_796413));
