...
public class UserProfileSettingActivity extends UI implements View.OnClickListener {
    ...
    private TextView user_profile_set_title;
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        user_profile_set_title = findView(R.id.user_profile_set_title);
        ToolBarOptions options = new ToolBarOptions();
        options.titleId = R.string.user_information;
        setToolBar(R.id.toolbar, options);
    //    user_profile_set_title.setText(R.string.user_information);
