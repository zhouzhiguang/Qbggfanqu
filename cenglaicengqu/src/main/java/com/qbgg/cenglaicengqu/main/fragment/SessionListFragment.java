...
public class SessionListFragment extends MainTabFragment {
    ...
    private static final int REQUEST_LOG_BACK=11;
    ...
    private LaiquApplication laiqu;
    ...
    private Handler handler=new Handler() {
        ...
        public void handleMessage(Message msg) {
            ...
            switch (msg.what){
               case     REQUEST_LOG_BACK:
                   LoginInfo info= laiqu.loginInfo();
                   loginRequest = NIMClient.getService(AuthService.class).login(info);
                   loginRequest.setCallback(new RequestCallback<LoginInfo>() {
                       @Override
                       public void onSuccess(LoginInfo info) {

                           DemoCache.setAccount(info.getAccount().toLowerCase());
    ...
    public void onActivityCreated(Bundle savedInstanceState) {
        ...
        onCurrent();
        laiqu= (LaiquApplication) getActivity().getApplication();
    }
