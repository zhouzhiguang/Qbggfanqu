package com.qbgg.cenglaicengqu.session;
...
import com.qbgg.cenglaicengqu.session.activity.MessageHistoryActivity;
import com.qbgg.cenglaicengqu.session.activity.MessageInfoActivity;
import com.qbgg.cenglaicengqu.session.extension.CustomAttachParser;
import com.qbgg.cenglaicengqu.session.extension.CustomAttachment;
import com.qbgg.cenglaicengqu.session.extension.RTSAttachment;
import com.qbgg.cenglaicengqu.session.extension.SnapChatAttachment;
import com.qbgg.cenglaicengqu.session.extension.StickerAttachment;
import com.qbgg.cenglaicengqu.session.search.SearchMessageActivity;
import com.qbgg.cenglaicengqu.session.viewholder.MsgViewHolderDefCustom;
import com.qbgg.cenglaicengqu.session.viewholder.MsgViewHolderSticker;
import com.qbgg.cenglaicengqu.session.viewholder.MsgViewHolderTip;
...
//            if(Build.VERSION.SDK_INT >= Build.VERSION_CODES.ICE_CREAM_SANDWICH) {
            //          actions.add(new AVChatAction(AVChatType.AUDIO));//音频通话消息
//                actions.add(new AVChatAction(AVChatType.VIDEO));//视频通话消息
//            }
//            //白班
