package com.qbgg.cenglaicengqu.session.activity;
...
import com.qbgg.cenglaicengqu.team.TeamCreateHelper;
...
public class MessageInfoActivity extends UI {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        TextView message_info__title=findView(R.id.message_info__title);

        ToolBarOptions options = new ToolBarOptions();
        options.titleId = R.string.message_info;
        options.navigateId = R.mipmap.actionbar_dark_back_icon;
        setToolBar(R.id.toolbar, options);
        message_info__title.setText(R.string.message_info);
